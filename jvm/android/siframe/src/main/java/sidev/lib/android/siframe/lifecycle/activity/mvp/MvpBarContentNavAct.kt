...
/**
 * Versi MVI dari BarContentNavAct. Kelas ini bkn merupakan keturunan MviAct.
 * Untuk pengecekan scr general, gunakan is Act atau is MviView.
 *
 ...
 */
abstract class MvpBarContentNavAct: BarContentNavAct(), MvpView{
