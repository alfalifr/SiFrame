...
import sidev.lib.android.siframe.util._EnvUtil;
import sidev.lib.implementation.universal.tool.util.TimeUtil;
...
public class LogHP {
    ...
    public LogHP(Application app){
        this.app= app;
        namaApp= app.getResources().getString(_ConfigBase.INSTANCE.getSTRING_APP_NAME()); //R.string.app_name);
...
//        cekIjinPrint();
    ...
    public void gantiAktifitas(Activity akt){
        ...
        namaApp= aktifitas.getResources().getString(_ConfigBase.INSTANCE.getSTRING_APP_NAME()); //R.string.app_name
