...
abstract class MviBarContentNavAct_ViewPager<F: Frag, I: ViewIntent, R: IntentResult, S: ViewState<*>>
    : BarContentNavAct_ViewPager<F>(), MviView<I, R, S> { //ViewPagerActBase<F>
