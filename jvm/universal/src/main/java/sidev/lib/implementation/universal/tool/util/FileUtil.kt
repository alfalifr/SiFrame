...
//            val newFile = File("c:/temp/testcopied.txt")
    ...
    fun fileTersedia(fileBaru: File, keterangan: String= "", pjgDigit: Int= 3): File{
        ...
        var strUrutan= sidev.lib.implementation.universal.tool.util.StringUtil.angka(urutan)
        strUrutan= sidev.lib.implementation.universal.tool.util.StringUtil.angkaString(strUrutan, pjgDigit)
