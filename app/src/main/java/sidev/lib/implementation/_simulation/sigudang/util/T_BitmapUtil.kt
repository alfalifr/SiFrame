...
//        val PICK_IMAGE_GALLERY_REQUEST= 1
    ...
    private fun pickImageGallery_Int(actOrFrag: Any, requestCode: Int= Constants.PICK_IMAGE_GALLERY_REQUEST){
        val intent = Intent()
    ...
    fun pickImageGallery(act: Activity, requestCode: Int= Constants.PICK_IMAGE_GALLERY_REQUEST){
        pickImageGallery_Int(act, requestCode)
    }
    fun pickImageGallery(frag: Fragment, requestCode: Int= Constants.PICK_IMAGE_GALLERY_REQUEST){
        pickImageGallery_Int(frag, requestCode)
    }

    private fun pickImageGalleryMultiple_Int(actOrFrag: Any, requestCode: Int= Constants.INTENT_PICK_IMAGE_MULTIPLE){
        val intent = Intent()
        intent.type = "image/*"
    ...
    fun savePict(bm: Bitmap, pathFile: String,
                 fileName: String= T_TimeUtil.timestamp()
    ): File? {
