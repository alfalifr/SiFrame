...
@Deprecated(
    "Gunakan fungsi alternatif yg setara",
    level = DeprecationLevel.ERROR
)
internal object _AnkoInternals{
    ...
    @JvmStatic
    fun fillIntentArguments(intent: Intent, params: Array<out Pair<String, Any?>>, replaceExisting: Boolean = true) {
        if(replaceExisting){
            for(it in params) {
                val value = it.second
                when (value) {
